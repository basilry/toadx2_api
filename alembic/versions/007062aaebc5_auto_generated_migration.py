...
Revision ID: 007062aaebc5
Revises: 3430cf7edf8e
Create Date: 2024-09-28 15:48:38.588934
...
revision: str = '007062aaebc5'
down_revision: Union[str, None] = '3430cf7edf8e'
...
def downgrade() -> None:
    ...
    sa.Column('avg_price1', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
